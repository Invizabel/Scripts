...
if arch in ["armv6l", "armv7l"] and os.path.exists("arch/arm/boot/zImage") and os.path.getsize("arch/arm/boot/zImage") > 0:
    print("compiled succesfully")

elif arch in ["aarch64"] and os.path.exists("arch/arm64/boot/Image") and os.path.getsize("arch/arm64/boot/Image") > 0:
    print("compiled succesfully")
